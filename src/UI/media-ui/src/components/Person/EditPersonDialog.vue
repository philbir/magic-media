<template>
  <div>
    <v-dialog width="500" v-model="isOpen">
      <v-card elevation="2" v-if="person">
        ...
        <v-card-actions class="pa-1">
          <v-btn color="blue darken-1" text @click="onClickCreateUser">
            Create User
          </v-btn>
    ...
    <create-user-from-person-dialog
...
import CreateUserFromPersonDialog from "../User/CreateUserFromPersonDialog";
export default {
  components: {
    CreateUserFromPersonDialog,
  },
  props: {
    show: {
      type: Boolean,
